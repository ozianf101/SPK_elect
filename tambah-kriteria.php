...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$handle = $pdo->prepare('INSERT INTO kriteria (kode, nama_kriteria, bobot, urutan_order, ada_pilihan) VALUES (:kode, :nama_kriteria, :bobot, :urutan_order, :jenis_nilai)');
			...
			<?php endif; ?>			
				...
				<form action="tambah-kriteria.php" method="post">
					<div class="field-wrap clearfix">					
						<label>Kode Kriteria <span class="red">*</span></label>
					...
					<div class="field-wrap clearfix">					
						...
						<input type="number" name="bobot" value="<?php echo $bobot; ?>" step="01" max=4>
					</div>
					<div class="field-wrap clearfix">					
